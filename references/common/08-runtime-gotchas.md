...
- Official doc: For deterministic in-app playback, prefer `@zos/media` with bundled files and validate media lifecycle behavior. Source: https://docs.zepp.com/docs/reference/device-app-api/newAPI/media/Player/
