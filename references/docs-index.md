...
This index groups the main official Zepp OS references used by the skill. Prefer these links over informal sources.
...
## CLI, simulator, preview, and bridge
...
- BLE bridge API: https://docs.zepp.com/docs/reference/device-app-api/newAPI/ble/
- createConnect: https://docs.zepp.com/docs/reference/device-app-api/newAPI/ble/createConnect/
- send: https://docs.zepp.com/docs/reference/device-app-api/newAPI/ble/send/
- connectStatus: https://docs.zepp.com/docs/reference/device-app-api/newAPI/ble/connectStatus/
- disConnect: https://docs.zepp.com/docs/reference/device-app-api/newAPI/ble/disConnect/
...
- Device info / `screenShape`: https://docs.zepp.com/docs/reference/device-app-api/newAPI/device/getDeviceInfo/
